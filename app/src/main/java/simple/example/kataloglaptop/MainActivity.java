...
public class MainActivity extends AppCompatActivity {
    ...
    List<DaftarLaptop> daftarLaptopAdapter;
    ...
    private void setupListview () {
        adapter = new DaftarLaptopAdapter (this, daftarLaptopAdapter);
        lvDaftarMenuRestoran.setAdapter (adapter);
    }

    private void loadDataMenuRestoran () {
        daftarLaptopAdapter = SharedPreferenceUtility.getAllMenuRestoran (this);
    }

    private void refreshListView () {
        adapter.clear ();
        loadDataMenuRestoran ();
        adapter.addAll (daftarLaptopAdapter);
    }

    private void bukaFormTambahMenuRestoran () {
        Intent intent = new Intent (this, FromKatalogLaptop.class);
